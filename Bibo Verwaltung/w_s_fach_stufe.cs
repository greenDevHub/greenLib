...
namespace Bibo_Verwaltung
{
    public partial class w_s_fach_stufe : MetroFramework.Forms.MetroForm
    {
        ...
        string currentUser;
        bool gast = false;
        public w_s_fach_stufe(string userName, MetroStyleManager msm)
        {
            InitializeComponent();
            msm_fach_stufe = msm;
        ...
        {
            w_s_selfmade_dialog custom = new w_s_selfmade_dialog("Modusauswahl", "Wählen Sie den Import- oder den Export-Modus!", "Daten-Import", "Daten-Export", msm_fach_stufe);
            msm_fach_stufe.Clone(custom);
