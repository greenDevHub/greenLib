...
namespace RabbitCode.Samples.MoonTaxi
{
    ...
    public class Game1 : Game
    {
        ...
        public const float MAXPICKUPDISTANCE = 20f; // Maximale Entfernung zum Sammelpunkt
        ...
        protected override void LoadContent()
        {
            ...
            guestTexture = Content.Load<Texture2D>("guest2");
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (taxi.Landed)
            {
                ...
                // Gastbehandlung
                Vector2 taxiPoint = taxi.Position + new Vector2(Taxi.WIDTH / 2, Taxi.HEIGHT / 2);
                if (taxi.GuestLoaded)
                {
                    Vector2 goalPoint = level.GoalPoint * BLOCKSIZE + new Vector2(BLOCKSIZE / 2, BLOCKSIZE / 2);
                ...
                {
                    Vector2 guestPoint = level.GuestPoint * BLOCKSIZE + new Vector2(BLOCKSIZE / 2, BLOCKSIZE / 2);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Draw(flame,
                new Rectangle(
                    (int)(taxi.Position.X + 20), 
                    (int)(taxi.Position.Y + 26), 
                    FLAMESIZE, 
                    (int)(taxi.JetBottom * FLAMESIZE)),
                new Rectangle(
            ...
            spriteBatch.Draw(flame,
                new Rectangle(
                    (int)(taxi.Position.X + 52),
                    (int)(taxi.Position.Y + 20),
                    FLAMESIZE,
                    (int)(taxi.JetRight * FLAMESIZE)),
                new Rectangle(
                    flameFrame == 0 ? 0 : FLAMESIZE,
                    0,
                    flameFrame == 0 ? FLAMESIZE : -FLAMESIZE,
            ...
            // HUD zeichnen
            spriteBatch.DrawString(font, "Level: " + levelNumber, new Vector2(10, 10), Color.White);
            ...
            spriteBatch.DrawString(font, taxiSpeed.ToString("0") + " px/s", new Vector2(speedSize.X + 15, 30), taxiSpeed > MAXLANDINGSPEED ? Color.Red : Color.Green);
            spriteBatch.DrawString(font, "Song: " + music.Artist + " / " + music.Name, new Vector2(10, 50), Color.White);
