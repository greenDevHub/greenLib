...
{
    class GrenadeLauncherTower : Object
    {
        public override bool HasSplitDamage
        {
            get
            {
                return true;
        ...
        public override void UpgradeObject()
        {
            if (Tier < 4)
            {
                ...
                splitDamage = (int)(splitDamage * 1.15f);
                splitRadius = (int)(splitRadius * 1.1f);
            }
        }
        ...
        public GrenadeLauncherTower(Texture2D[] texture, Texture2D bulletTexture, Texture2D rangeBorderTexture, Texture2D headupDisplayTexture, ObjectTypeConfig objectTypeConfig, Vector2 position)
